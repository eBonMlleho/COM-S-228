...
/**
 * A class full of tests for this assignment's iterator. The tests are arranged
 * by logical ordering (next and previous first, and so on), except for the
 * constructor tests, which happen first. Tests for the list itself appear in a
 * different file. I would recommend that you make sure that you pass the other
 * tests before you use these ones.
 * 
...
public class AdaptiveListIteratorTests {
	...
	public void DefaultConstructorTest1() {
		...
		int expected = 0;
		assertEquals("The iterator should begin at position 0 for the default constructor (nextIndex = 0).", expected,
				nextIndex);
	...
	public void DefaultConstructorTest2() {
		...
		int expected = -1;
		assertEquals("The iterator should begin at position 0 for the default constructor (prevIndex = -1).", expected,
				nextIndex);
	...
	public void MiddleConstructorTest1() {
		...
		int expected = 2;
		assertEquals("The iterator should begin at position 2 for the default constructor (nextIndex = 2).", expected,
				nextIndex);
	...
	public void MiddleConstructorTest2() {
		...
		int expected = 1;
		assertEquals("The iterator should begin at position 2 for the default constructor (prevIndex = 1).", expected,
				nextIndex);
	...
	public void EndConstructorTest1() {
		...
		int expected = 6;
		assertEquals("The iterator should begin at position 2 for the default constructor (nextIndex = 6).", expected,
				nextIndex);
	...
	public void EndConstructorTest2() {
		...
		int expected = 5;
		assertEquals("The iterator should begin at position 2 for the default constructor (prevIndex = 5).", expected,
				nextIndex);
	...
	// hasNext and nextIndex have already been tested implicitly, so no more tests
	// are needed there
	...
	// hasPrevious and previousIndex have already been tested implicitly, so no more
	...
	// tests if add changes the list correctly after two calls with a next in
	// between (initialIterator)
	@Test
	public void AddTest3() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(Begin, -, Next, u, i, u, hg, -)";
		assertEquals("The add method should add Begin, go past the null, and then add Next before the " + "cursor.",
				expected, toString);
	}
	...
	// tests if add increases the value of nextIndex (middleIterator) (so the same
	// value would be returned by next)
	@Test
	...
	// tests if add increases the value of previousIndex (middleIterator) (so the
	// same value would be returned by next)
	@Test
	...
	// tests if remove changes the list correctly after one next call
	// (initialIterator)
	@Test
	public void RemoveTest1() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(u, i, u, hg, -)";
		assertEquals("The remove method should remove the null item that was just passed over (by next or previous).",
				expected, toString);
	}

	// tests if remove changes the list correctly after one next and one previous
	// call (initialIterator)
	@Test
	...
	// tests if remove changes the list correctly after two next calls
	// (initialIterator)
	@Test
	public void RemoveTest3() {
		...
		assertEquals("The remove method should remove the u that was just passed over (next or previous).", expected,
				toString);
	}

	// tests if remove changes the list correctly after two next and one previous
	// call (initialIterator)
	@Test
	public void RemoveTest4() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(-, i, u, hg, -)";
		assertEquals("The remove method should remove the u item that was just passed over (next or previous).",
				expected, toString);
	}

	// tests if remove changes the list correctly after one previous call
	// (endIterator)
	@Test
	public void RemoveTest5() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(-, u, i, u, hg)";
		assertEquals("The remove method should remove the null item that was just passed over (next or previous).",
				expected, toString);
	}

	// tests if remove changes the list correctly after two previous calls
	// (endIterator)
	@Test
	public void RemoveTest6() {
		...
		assertEquals("The remove method should remove the hg that was just passed over (next or previous).", expected,
				toString);
	}

	// tests if remove changes the list correctly after two previous calls and one
	// next call (endIterator)
	@Test
	...
	// tests if remove changes the list correctly after a previous call, remove,
	// add, next, and another remove (endIterator)
	@Test
	...
	// tests if remove changes the list correctly after a previous call, remove,
	// next, and another remove (endIterator)
	@Test
	public void RemoveTest9() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(-, u, i, u)";
		assertEquals("The remove method should work after a call to set, even with no next in between.", expected,
				toString);
	}

	// tests if remove changes the list correctly after a three add calls, next, and
	// remove (middleIterator)
	@Test
	public void RemoveTest10() {
		...
		assertEquals("The remove method should work after a call to next, even after three add calls.", expected,
				toString);
	}
	...
	public void SetTest1() {
		...
		assertEquals("The set method should change item that was just passed over to P (by next or previous).",
				expected, toString);
	}

	// tests if set changes the list correctly after one next call and one previous
	// call (initialIterator)
	@Test
	public void SetTest2() {
		...
		String toString = list.toStringLinked().substring(55);
		String expected = "(P, u, i, u, hg, -)";
		assertEquals("The set method should change the null item that was just passed over to P (by next or previous).",
				expected, toString);
	}

	// tests if set changes the list correctly after two next calls
	// (initialIterator)
	@Test
	public void SetTest3() {
		...
		assertEquals("The set method should change the u that was just passed over to P (by next or previous).",
				expected, toString);
	}

	// tests if set changes the list correctly after two next calls and a previous
	// call (initialIterator)
	@Test
	...
	// tests if set changes the list correctly after one previous call and one next
	// call (endIterator)
	@Test
	...
	// tests if set changes the list correctly after two previous calls
	// (endIterator)
	@Test
	public void SetTest7() {
		...
		assertEquals("The set method should change the hg that was just passed over to P (by next or previous).",
				expected, toString);
	}

	// tests if set changes the list correctly after two previous calls and a next
	// call (endIterator)
	@Test
	...
	// tests if set changes the list correctly after a previous, set, add, previous,
	// set, and remove calls (endIterator)
	@Test
	...
	// tests if set changes the list correctly after a previous, and 3 set calls
	// (endIterator)
	@Test
	...
	// tests if set changes the list correctly after a previous, 3 set calls,
	// previous, add, next, and set again. (endIterator)
	@Test
