...
/**
 * A class full of tests for this assignment. The tests are arranged
 * alphabetically by method name in general (except for the constructor tests,
 * which happen first). Tests for the iterator will appear in another test file.
 * 
...
public class AdaptiveListTests {
	...
	public void AddTest2() {
		...
		int expected = 1;
		assertEquals("After calling add(\"oi\") on the empty list, the size should have increased to 1.", expected,
				newSize);
	}
	...
	public void AddPosTest1() {
		...
		int newSize = list.size();
		int expected = 1;
		assertEquals("After calling add(0,\"oi\") on the empty list, the size should have " + "increased to 1.",
				expected, newSize);
	}
	...
	public void AddPosTest2() {
		...
		String expected = "(oi)";
		assertEquals("After calling add(0,\"oi\") on the empty list, oi should have been " + "added to the list.",
				expected, newSize);
	}
	...
	public void AddPosTest3() {
		...
		int expected = 2;
		assertEquals(
				"After calling add(1,\"oi\") on the a list with 1 element, the size should have " + "increased to 2.",
				expected, newSize);
	}
	...
	public void AddPosTest4() {
		...
		assertEquals(
				"After calling add(1,\"oi\") on the a list with 1 element, oi should have been " + "added to the end.",
				expected, newSize);
	}

	// tests to see if adding explicitly at the beginning changes the list size
	// correctly
	@Test
	public void AddPosTest5() {
		...
		int expected = 2;
		assertEquals(
				"After calling add(0,\"oi\") on the a list with 1 element, the size should have " + "increased to 2.",
				expected, newSize);
	}
	...
	public void AddAllTest2() {
		...
		assertEquals("After calling addAll(otherList) on the empty list, the list should " + "be equal to otherList.",
				expected, newSize);
	}
	...
	// tests to see if addAll(pos) changes the list correctly with the list itself
	// at the beginning
	@Test
	...
	// tests if contains returns true with the null elements appearing multiple
	// times
	@Test
	...
	// tests to see if containsAll works correctly after adding more than the
	// otherList
	@Test
	...
	// tests to see if containsAll works correctly after removing a duplicate
	// element from otherList
	@Test
	...
	// tests to see if containsAll works correctly after removing a unique element
	// from otherList
	@Test
	...
	// no explicit tests needed for getlinkedUTD, getArrayUTD, or hashCode (already
	// provided)
	...
	public void IndexOfTest2() {
		...
		int expected = 0;
		assertEquals(
				"IndexOf should return the zero-based index of the requested element " + "on the one element list.",
				expected, not);
	}
	...
	// not tests needed for iterator, listiterator, listiterator(pos) (already
	// provided)

	// tests to see if lastIndexOf returns the correct value for values not in the
	// list
	@Test
	...
	// tests to see if removeAll works correctly after adding otherList and another
	// element in otherList (size)
	@Test
	...
	public void RemoveAllTest4() {
		...
		String expected = "()";
		assertEquals(
				"After adding and removing the same list with an element in otherList, " + "the list should be empty.",
				expected, newSize);
	}

	// tests to see if removeAll works correctly after adding otherList and another
	// element not in otherList (size)
	@Test
	...
	public void RetainAllTest1() {
		...
		int expected = otherList.size();
		assertEquals(
				"After adding and then retaining the list, the size should be the same as " + "the added list's size.",
				expected, newSize);
	}
	...
	public void RetainAllTest2() {
		...
		String newSize = list.toStringLinked().substring(55);
		String expected = "(-, u, i, u, hg, -)";
		assertEquals("After adding and retaining the same list, the list should be the same as the added list.",
				expected, newSize);
	}

	// tests to see if retainAll works correctly after adding otherList and another
	// element in otherList (size)
	@Test
	...
	// size has already been implicitly tested (frequently), and subList requires no
	// testing
	...
	// checks if the array generated by toArray is not just the same as the internal
	// array
	@Test
	...
	// checks if toArray(array) works correctly for a long list (should be very
	// similar)
	@Test
	...
	// checks if toArray(array) works correctly for a short list (should be very
	// similar)
	@Test
	...
	// checks if toArray(array) works correctly for an equal size list (should be
	// very similar)
	@Test
